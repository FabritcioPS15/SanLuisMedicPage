...
import { Check, Clock, FileText, Shield, ArrowRight, Phone, MapPin, Bike, ChevronDown, Menu, Mail, X, ChevronRight } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-4 text-[10px] font-black uppercase tracking-widest text-white/40">
              ...
              <ChevronRight size={10} />
              <span className="text-[#a3c435]">Licencia Moto</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-6 leading-tight">
              Examen Médico <br /> <span className="text-[#158cca]">Licencia de Moto</span>
            </h1>
            <p className="hidden md:block text-white/60 text-lg max-w-2xl mx-auto font-medium">
              Evaluación médica rápida y certificada para conductores de vehículos menores, cumpliendo con todos los estándares del MTC.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 relative z-10">
          ...
          <div>
            <h2 className="text-3xl font-black text-[#0f172a] uppercase tracking-tighter mb-8 leading-none">
              Tu Licencia de <br /> <span className="text-[#158cca]">Moto en un Paso</span>
            </h2>
            <div className="space-y-8">
              <div className="p-6 bg-slate-50 border-l-4 border-[#158cca]">
                <h3 className="font-black text-[#0f172a] uppercase tracking-widest text-xs mb-4">¿Qué se evalúa?</h3>
                <ul className="space-y-3">
                  {[
                    "Examen de vista y oído",
                    "Evaluación psicológica",
                    "Examen de medicina general",
                    "Registro inmediato en el sistema MTC"
                  ].map((req, i) => (
              ...
              <Card className="p-5 border-slate-100 shadow-sm rounded-none relative overflow-hidden group hover:border-[#158cca] transition-colors">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h4 className="font-black text-[#0f172a] uppercase tracking-widest text-[10px] mb-1">Vehículos Autorizados</h4>
                    <p className="text-sm font-bold text-slate-600 italic">Motos y trimotos (B-IIc)</p>
              ...
              <div className="pt-8 mt-8 border-t border-slate-100">
                ...
                <div className="space-y-6">
                  {[
                    { title: "Examen Psicológico Básico", desc: "Evaluación de reflejos y aptitud psicológica para vehículos menores." },
                    { title: "Evaluación Visual y Auditiva", desc: "Pruebas fundamentales de visión y audición en ruta." },
                    { title: "Chequeo Médico General", desc: "Verificación de condiciones físicas generales." },
                    { title: "Aprobación y Registro", desc: "Certificación inmediata para trámite de licencia B-II." }
                  ].map((step, idx) => (
          ...
          <div className="space-y-8">
            <div className="bg-[#0f172a] p-6 md:p-10 text-white relative">
              ...
              <div className="relative z-10">
                ...
                <a
                  href={getWhatsAppUrl(`Hola San Luis Medic, quiero mi examen para Licencia de Moto en la sede ${selectedSede.name}`, selectedSede.whatsapp)}
                  target="_blank"
                  rel="noreferrer"
...
export default function LicenciaMoto() {
  return (
