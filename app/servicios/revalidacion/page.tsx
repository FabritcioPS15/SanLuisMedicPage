...
import { Check, Clock, FileText, Shield, ArrowRight, Phone, MapPin, RefreshCw, ChevronDown, Menu, Mail, X, ChevronRight } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-4 text-[10px] font-black uppercase tracking-widest text-white/40">
              ...
              <ChevronRight size={10} />
              <span className="text-[#a3c435]">Revalidación</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-6 leading-tight">
              Renovar <br /> <span className="text-[#158cca]">Licencia de Conducir</span>
            </h1>
            <p className="hidden md:block text-white/60 text-lg max-w-2xl mx-auto font-medium">
              Renueva tu licencia de conducir de forma rápida, segura y con certificación inmediata ante el MTC.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 relative z-10">
          ...
          <div>
            <h2 className="text-3xl font-black text-[#0f172a] uppercase tracking-tighter mb-8 leading-none">
              Requisitos y <br /> <span className="text-[#158cca]">Proceso del Examen</span>
            </h2>
            <div className="space-y-8">
              <div className="p-6 bg-slate-50 border-l-4 border-[#158cca]">
                <h3 className="font-black text-[#0f172a] uppercase tracking-widest text-xs mb-4">¿Qué necesitas traer?</h3>
                <ul className="space-y-3">
                  {[
                    "DNI vigente (físico o electrónico)",
                    "Licencia de conducir a revalidar",
                    "No tener multas electorales pendientes",
                    "No tener multas de tránsito sin cancelar"
                  ].map((req, i) => (
              ...
              <Card className="p-5 border-slate-100 shadow-sm rounded-none relative overflow-hidden group hover:border-[#158cca] transition-colors">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h4 className="font-black text-[#0f172a] uppercase tracking-widest text-[10px] mb-1">Revalidación de Brevete</h4>
                    <p className="text-sm font-bold text-slate-600 italic">Aprox. 2 horas y media</p>
                    <p className="text-[11px] text-slate-400 font-medium mt-1">Certificación 100% Oficial MTC</p>
                  </div>
                </div>
              ...
              <div className="pt-8 mt-8 border-t border-slate-100">
                ...
                <div className="space-y-6">
                  {[
                    { title: "Examen Médico Breve", desc: "Verificación del estado general de salud y signos vitales básicos." },
                    { title: "Evaluación Visual y Auditiva", desc: "Comprobación de condiciones visuales y auditivas actuales." },
                    { title: "Actualización de Datos", desc: "Confirmación de información y actualización en el sistema MTC." },
                    { title: "Certificación Biométrica", desc: "Firma digital y huella para emisión automática del certificado." }
                  ].map((step, idx) => (
          ...
          <div className="space-y-8">
            <div className="bg-[#0f172a] p-6 md:p-10 text-white relative">
              <div className="relative z-10">
                ...
                <a
                  href={getWhatsAppUrl(`Hola San Luis Medic, quiero revalidar mi brevete en la sede ${selectedSede.name}`, selectedSede.whatsapp)}
                  target="_blank"
                  rel="noreferrer"
              ...
              <div className="absolute top-0 right-0 w-32 h-32 opacity-10 pointer-events-none">
                <Image src="/MTC.webp" alt="MTC" fill className="object-contain" />
              </div>
            </div>
...
export default function Revalidacion() {
  return (
